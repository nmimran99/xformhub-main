		...
		<Modal hideControls>
			...
			>
				...
				>
					...
					<div
						className="rounded-xl mx-auto p-4 flex border border-gray-300 my-2 w-80
						sm:mx-0
					"
					>
						<img
							src={trainer.avatar}
							className="rounded-full w-24 border-2 border-white ring ring-blue-500"
						/>
						<div className="my-auto">
							<div className="text-lg px-5">{getFullName(trainer)}</div>
							<div className="text-sm px-5 ">{getCity(trainer)}</div>
							{trainer.isVerified && (
